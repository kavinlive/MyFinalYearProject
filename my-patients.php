									...
									<div class="card widget-profile pat-widget-profile">
										<div class="card-body">
											<div class="pro-widget-content">
												<div class="profile-info-widget">
													<a href="#" class="booking-doc-img">
														<img src="<?php echo $row3['Patient_Image']; ?>" alt="User Image" onerror=this.src="Assets/img/Patients/Patient.jpg">
													</a>
													<div class="profile-det-info">
														<h3><a href="#"><?php echo $row3['Patient_Name']; ?></a></h3>

														<div class="patient-details">
															<h5><b>Patient ID :</b> <?php echo $row3['Patient_ID']; ?></h5>
															<h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> <?php echo $row3['City']." , ".$row3['State']; ?></h5>
														</div>
													</div>
												</div>
											</div>
											<div class="patient-info">
												<ul>
													<li>Phone <span><?php echo $row3['Patient_Mobile']; ?></span></li>
													<li>Sex <span><?php echo $row3['Patient_Sex']; ?></span></li>
													<li>Blood Group <span><?php echo $row3['Blood_Group']; ?></span></li>
												</ul>
											</div>
										</div>
									</div>
