							...
							<div class="card">
								<div class="card-body">
									<ul class="nav nav-tabs nav-tabs-solid nav-justified">
										<li class="nav-item"><a class="nav-link active" href="#AllLetestAppointments" data-toggle="tab">Previous Appointments</a></li>
									</ul>
								</div>
												...
												<div class="card card-table mb-0">
													<div class="card-body">
														<div class="table-responsive">
															<table id="PatientPreviousAppointmentDetails" class="table table-hover table-center mb-0">
															</table>
														</div>
													</div>
												</div>
